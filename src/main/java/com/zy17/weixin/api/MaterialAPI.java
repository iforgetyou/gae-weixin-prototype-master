...
import com.zy17.weixin.bean.material.Description;
import com.zy17.weixin.bean.material.MaterialBatchgetResult;
import com.zy17.weixin.bean.material.MaterialcountResult;
import com.zy17.weixin.bean.material.NewsItem;
import com.zy17.weixin.bean.media.Media;
import com.zy17.weixin.bean.media.MediaType;
...
import com.zy17.weixin.util.StreamUtils;
...
public class MaterialAPI extends BaseAPI {
     ...
     * @return
     */
    public static Media materialAdd_material(String access_token, MediaType mediaType, File media,
     ...
     * @return
     */
    public static Media materialAdd_material(String access_token, MediaType mediaType, InputStream inputStream,
                                             Description description) {
        HttpPost httpPost = new HttpPost(BASE_URI + "/cgi-bin/material/add_material");
        byte[] data = null;
        try {
     ...
     * @return
     */
    public static Media materialAdd_material(String access_token, MediaType mediaType, URI uri, Description
            description) {
        HttpPost httpPost = new HttpPost(BASE_URI + "/cgi-bin/material/add_material");
        ...
        try {
            ...
            MultipartEntityBuilder multipartEntityBuilder = MultipartEntityBuilder.create()
                    .addBinaryBody("media", EntityUtils.toByteArray(entity), ContentType.get(entity),
     ...
     * @return
     */
    public static BaseResult materialUpdate_news(String access_token, String media_id, int index, List<Article>
            articles) {
        String str = JsonUtil.toJSONString(articles);
     ...
     * @return
     */
    public static MaterialBatchgetResult materialBatchget_material(String access_token, String type, int offset, int
            count) {
        HttpUriRequest httpUriRequest = RequestBuilder.post()
