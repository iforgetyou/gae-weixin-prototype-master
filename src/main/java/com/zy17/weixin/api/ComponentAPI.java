...
import com.zy17.weixin.bean.component.AuthorizerAccessToken;
import com.zy17.weixin.bean.component.AuthorizerInfo;
import com.zy17.weixin.bean.component.AuthorizerOption;
import com.zy17.weixin.bean.component.ComponentAccessToken;
import com.zy17.weixin.bean.component.PreAuthCode;
...
public class ComponentAPI extends BaseAPI {
     ...
     * @return
     */
    public ComponentAccessToken api_component_token(String component_appid, String component_appsecret,
                                                    String component_verify_ticket) {
        String postJsonData = String.format(
                "{\"component_appid\":\"%1$s\" ,\"component_appsecret\": \"%2$s\",\"component_verify_ticket\": "
                        + "\"%3$s\"}",
                component_appid,
                component_appsecret,
     ...
     * @return
     */
    public AuthorizerInfo api_query_auth(String component_access_token, String component_appid,
     ...
     * @param authorizer_refresh_token 授权方的刷新令牌，刷新令牌主要用于公众号第三方平台获取和刷新已授权用户的access_token，只会在授权时刻提供，请妥善保存。
